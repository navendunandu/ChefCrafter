    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <h3 class="text-primary">Chef<span style="color:white;letter-spacing: 2px;">Crafter</h3>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0"><?php echo $_SESSION['adname'] ?></h6>
                        <span>Admin</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Manage Chef</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="NewChef.php" class="dropdown-item">New Chef</a>
                            <a href="ChefList.php" class="dropdown-item">Chef List</a>
                            <a href="RejectedChef.php" class="dropdown-item">Rejected Chef</a>
                        </div>
                    </div>
                    <a href="Complaints.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Complaints</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Food</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="FoodType.php" class="dropdown-item">Food Type</a>
                            <a href="Category.php" class="dropdown-item">Category</a>
                            <a href="Food.php" class="dropdown-item">Food</a>
                        </div>
                    </div><div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Location</a>
                        <div class="dropdown-menu bg-transparent border-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex"><?php echo $_SESSION['adname'] ?></span>
                        </a>
