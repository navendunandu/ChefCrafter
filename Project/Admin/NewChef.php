...
<div class="container mt-4">
    <table class="table table-bordered">
        ...
        <tbody>
            <?php
            $selQry = "select * from tbl_chef c inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id where chef_vstatus=0";
            ...
            while ($data = $res->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td>
                        <a href='NewChef.php?id=<?php echo $data['chef_id'] ?>&st=1' class="btn btn-success">Accept</a>
                        <a href='NewChef.php?id=<?php echo $data['chef_id'] ?>&st=2' class="btn btn-danger">Reject</a>
                    </td>
                </tr>
                <?php
            }
