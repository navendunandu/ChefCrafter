...
<html lang="en">
  <head>
    <title>ChefCrafter &mdash; Onepage Website Template by Free-Template.co</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="../Assets/Templates/User/fonts/ionicons/css/ionicons.min.css">
    <link rel="stylesheet" href="../Assets/Templates/User/fonts/fontawesome/css/font-awesome.min.css">
  ...
  <body>
    ...
    <header role="banner">
      <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container">
          <a class="navbar-brand" href="index.html">ChefCrafter</a>
    ...
    <div class="slider-wrap">
      <section class="home-slider owl-carousel">
        ...
        <div class="slider-item" style="background-image: url('../Assets/Templates/User/img/hero_1.jpg');">
          
          <div class="container">
            <div class="row slider-text align-items-center justify-content-center">
              <div class="col-md-8 text-center col-sm-12 ">
                <h1 data-aos="fade-up">Enjoy Your Food at ChefCrafter</h1>
                <p data-aos="fade-up" data-aos-delay="200"><a href="SearchChef.php" class="btn btn-white btn-outline-white">Get A Chef!</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="slider-item" style="background-image: url('../Assets/Templates/User/img/hero_2.jpg');">
          <div class="container">
            <div class="row slider-text align-items-center justify-content-center">
              <div class="col-md-8 text-center col-sm-12 ">
    ...
    <section class="section pb-0">
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-lg-4">
            <img src="../Assets/Templates/User/img/dishes_1.jpg" alt="Free website template by Free-Template.co" class="img-fluid about_img_1" data-aos="fade" data-aos-delay="200">
          </div>
          <div class="col-lg-4">
            <img src="../Assets/Templates/User/img/about_1.jpg" alt="Free website template by Free-Template.co" class="img-fluid about_img_1" data-aos="fade" data-aos-delay="300">
            <img src="../Assets/Templates/User/img/about_2.jpg" alt="Free website template by Free-Template.co" class="img-fluid about_img_1" data-aos="fade" data-aos-delay="400">
          </div>
          <div class="col-lg-4">
            <img src="../Assets/Templates/User/img/dishes_3.jpg" alt="Free website template by Free-Template.co" class="img-fluid about_img_1" data-aos="fade" data-aos-delay="500">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="clearfix mb-5 pb-5">
        ...
        <div class="owl-carousel centernonloop">
          <a href="#" class="item-dishes" data-aos="fade-right" data-aos-delay="100">
            ...
            <img src="../Assets/Templates/User/img/dishes_1.jpg" alt="" class="img-fluid">
          </a>
          <a href="#" class="item-dishes" data-aos="fade-right" data-aos-delay="200">
            ...
            <img src="../Assets/Templates/User/img/dishes_2.jpg" alt="" class="img-fluid">
          </a>
          <a href="#" class="item-dishes" data-aos="fade-right" data-aos-delay="300">
            ...
            <img src="../Assets/Templates/User/img/dishes_3.jpg" alt="" class="img-fluid">
          </a>
          <a href="#" class="item-dishes" data-aos="fade-right" data-aos-delay="400">
            ...
            <img src="../Assets/Templates/User/img/dishes_4.jpg" alt="" class="img-fluid">
          </a>
        </div>
      </div>
        ...
        <div class="row no-gutters">
          <div class="col-md-6">
            <div class="sched d-block d-lg-flex">
              <div class="bg-image order-2" style="background-image: url('../Assets/Templates/User/img/dishes_4.jpg');" data-aos="fade"></div>
            ...
            <div class="sched d-block d-lg-flex">
              <div class="bg-image" style="background-image: url('../Assets/Templates/User/img/dishes_1.jpg');" data-aos="fade"></div>
              <div class="text">
          ...
          <div class="col-md-6">
            <div class="sched d-block d-lg-flex">
              <div class="bg-image order-2" style="background-image: url('../Assets/Templates/User/img/dishes_2.jpg');" data-aos="fade"></div>
              <div class="text order-1">
            ...
            <div class="sched d-block d-lg-flex">
              <div class="bg-image" style="background-image: url('../Assets/Templates/User/img/dishes_3.jpg');" data-aos="fade"></div>
              <div class="text">
            ...
            <div class="owl-carousel centernonloop2">
              <div class="slide" data-aos="fade-left" data-aos-delay="100">
                <blockquote class="testimonial">
                  ...
                  <div class="d-flex author">
                    <img src="../Assets/Templates/User/img/person_1.jpg" alt="" class="mr-4">
              ...
              <div class="slide" data-aos="fade-left" data-aos-delay="200">
                <blockquote class="testimonial">
                  <p>&ldquo; Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. &rdquo;</p>
                  <div class="d-flex author">
                    <img src="../Assets/Templates/User/img/person_2.jpg" alt="" class="mr-4">
                    <div class="author-info">
              ...
              <div class="slide" data-aos="fade-left" data-aos-delay="300">
                <blockquote class="testimonial">
                  <p>&ldquo; Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. &rdquo;</p>
                  <div class="d-flex author">
                    <img src="../Assets/Templates/User/img/person_3.jpg" alt="" class="mr-4">
                    <div class="author-info">
                      <h4>Charles White</h4>
                      <p>CEO, XYZ Company</p>
                    </div>
        ...
        <div class="row">
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="blog d-block">
              <a class="bg-image d-block" href="single.html" style="background-image: url('../Assets/Templates/User/img/dishes_1.jpg');"></a>
              <div class="text">
          ...
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="blog d-block">
              <a class="bg-image d-block" href="single.html" style="background-image: url('../Assets/Templates/User/img/dishes_2.jpg');"></a>
              <div class="text">
                <h3><a href="single.html">How To Cook Pasta?</a></h3>
                <p class="sched-time">
                  <span><span class="fa fa-calendar"></span> April 22, 2018</span> <br>
    ...
    <footer class="site-footer" role="contentinfo">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <small class="block">&copy; 2019 <strong class="text-black">ChefCrafter</strong> Free Template. All Rights Reserved. <br> Design by <a href="https://free-template.co/" target="_blank">Free-Template.co</a></small> 
          </p>
          </div>
        </div>
      </div>
    ...
    <script src="../Assets/Templates/User/js/jquery-3.2.1.min.js"></script>
    <script src="../Assets/Templates/User/js/popper.min.js"></script>
    <script src="../Assets/Templates/User/js/bootstrap.min.js"></script>
    <script src="../Assets/Templates/User/js/owl.carousel.min.js"></script>
    <script src="../Assets/Templates/User/js/jquery.waypoints.min.js"></script>
    <script src="../Assets/Templates/User/js/aos.js"></script>

    <script src="../Assets/Templates/User/js/jquery.magnific-popup.min.js"></script>
    <script src="../Assets/Templates/User/js/magnific-popup-options.js"></script>
